...
document.getElementById('loginForm').addEventListener('submit', function (e) {
    ...
    signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            window.location.href = "tarifa.html"; // Substitua com a URL da página de ADMIN
            } else {
                // Redireciona para a página do funcionário
                window.location.href = "estacionamento.html"; // Substitua com a URL da página de funcionário
            }
        })
        .catch((error) => {
